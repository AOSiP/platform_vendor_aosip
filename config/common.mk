...
PRODUCT_COPY_FILES += \
    ...
    vendor/aosip/prebuilt/common/etc/permissions/privapp-permissions-elgoog-product.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/privapp-permissions-elgoog.xml \
